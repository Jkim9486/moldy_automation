...
input_filename='example\HgI2.rdf';
atom={};
atom(1,:)={'Hg',1};
atom(2,:)={'I_1',1};
atom(3,:)={'I_2',1};
...
Box_length=35.0762; %% Check in moldy '~.out' file.
solvent={'C','H_2','H_1'}; %% For off cage calculate;

%solvent={'O','C','H_1','H_2'}; %% For cage term calculation.
